...
<li class="nav-item"><a class="nav-link text-light" href="/logout">Logout</a></li>
	...
	<c:choose>
		<c:when test="${fn:length(orderhis) eq 0}">
			<h2 style="text-align: center">No Orders </h2>
		</c:when>
		<c:otherwise>
			<p style="text-align: center; color: green; font-size: 30px; font-weight: bolder;">YOUR ORDERS
				</p>
			<br /><!-- 		<f:form action="viewordersadmin" method="post" modelAttribute="filter">
...
-->			
			...
			<table class="table table-hover" style="padding-top: 5em;">
				...
				<tbody>
					<c:forEach items="${orderhis}" var="ord">
						<tr>
