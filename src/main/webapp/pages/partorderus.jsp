...
<body style="background-color: white;">
	...
	<c:choose>
		...
		<c:otherwise>
			<p
				style="text-align: center; color: green; font-size: 30px; font-weight: bolder;">ORDER DETAILS
			</p>
		...
		<br/>
		<p style="text-align: right;font-size: 18px;font-weight: bold;">Status: ${partdetail.get(0).status}</p>
		<br/>
	...
	<br/>
<p style="text-align: center;"><a  class="btn btn-outline-secondary btn-lg" href="/orderhistory"> Back</a>
</p>
</body>
