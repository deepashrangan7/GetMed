...
<body>
    ...
    <div class="tile">
        ...
        <div class="tile-body">
            <f:form id="form" action="recoverymap" method="post" modelAttribute="rb" >
                <label class="form-input">
                    <i class="material-icons">person</i>
                    <f:input type="text" path="a1" autofocus="true" name="a1"  required="true"/>
                    <span class="label">What is your Nick name?</span>
                    <div class="underline"></div>
                </label>
              <p style="color:red;">  <f:errors path="a1"></f:errors></p>
                <label class="form-input">
                    <i class="material-icons">person</i>
                    <f:input path="a2" type="text" autofocus="true" name="a2" required="true" />
                    <span class="label">What is your Favourite colour?</span>
                    <div class="underline"></div>
                </label>
                <p style="color:red;"><f:errors path="a2"></f:errors></p>
                <label class="form-input">
                    <i class="material-icons">person</i>
                    <f:input path="a3" type="text" autofocus="true" name="a3" required="true" />
                    <span class="label">Who is your Favourite Hero?</span>
                    <div class="underline"></div>
                </label>
                <p style="color:red;"><f:errors path="a3"></f:errors></p>
               <br/><br/>
